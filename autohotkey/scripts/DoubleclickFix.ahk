; Copyright belongs to Lexikos
; See https://autohotkey.com/board/topic/82509-software-fix-for-double-clicking-mouse/
; and https://github.com/Lexikos
; This script just prevents my broken mouse from double clicking.
